...
type Snapshot_Meta struct {
	...
	FromLmdbTxnID        int64    `protobuf:"varint,8,opt,name=fromLmdbTxnID,proto3" json:"fromLmdbTxnID,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
}
...
func (m *Snapshot_Meta) GetFromLmdbTxnID() int64 {
	if m != nil {
		return m.FromLmdbTxnID
	}
	return 0
}
...
var fileDescriptor_0c8aab8e59648e0b = []byte{
	...
	,
}
...
func (this *Snapshot_Meta) VerboseEqual(that interface{}) error {
	...
	if this.FromLmdbTxnID != that1.FromLmdbTxnID {
		return fmt.Errorf("FromLmdbTxnID this(%v) Not Equal that(%v)", this.FromLmdbTxnID, that1.FromLmdbTxnID)
	}
	return nil
}
...
func (m *Snapshot_Meta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.FromLmdbTxnID != 0 {
		i = encodeVarintSnapshot(dAtA, i, uint64(m.FromLmdbTxnID))
		i--
		dAtA[i] = 0x40
	}
...
func NewPopulatedSnapshot_Meta(r randySnapshot, easy bool) *Snapshot_Meta {
	...
	this.FromLmdbTxnID = int64(r.Int63())
	if r.Intn(2) == 0 {
		this.FromLmdbTxnID *= -1
	}
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func (m *Snapshot_Meta) Size() (n int) {
	...
	if m.FromLmdbTxnID != 0 {
		n += 1 + sovSnapshot(uint64(m.FromLmdbTxnID))
	}
	return n
}
...
func (m *Snapshot_Meta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FromLmdbTxnID", wireType)
			}
			m.FromLmdbTxnID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FromLmdbTxnID |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
